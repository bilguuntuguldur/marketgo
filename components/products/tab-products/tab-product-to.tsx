...
const TabProductTwo: React.FC<ProductProps> = ({ categoryId, post_per_product }) => {
    ...
    return (
        <div id="tab_besseller_product" className="tab_content animatetab">
            <div className="productTabContent1 productTab">
                <div className="img">
                    <div className="img_modun">
                        <div className="banner-box"><a href="#"> <Image src="/images/banner/nonner.png" alt="simply-alt-text" className="img-responsive" width={450} height={440} /></a></div>
                    </div>
                </div>
