...
const TabProductOne: React.FC<ProductProps> = ({ categoryId, post_per_product }) => {
    ...
    return (
        <div id="tab_new_product" className="tab_content animatetab active">
            <div className="productTabContent0 productTab">
                <div className="img">
                    <div className="img_modun">
                        <div className="banner-box"><a href="#"> <Image src="/images/banner/nanner.png" alt="simply-alt-text" className="img-responsive" width={450} height={440} /></a></div>
                    </div>
                </div>
